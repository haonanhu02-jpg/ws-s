...
final class EmployeeDormitoryModels {
 ...
 record StayImportCommand(@NotBlank String name,String centerName,@NotBlank String department,@Pattern(regexp="男|女") String gender,String category,String positionName,String rankName,@NotBlank String buildingName,@NotBlank String roomNo,@NotBlank String bedCode,String applicationCode,String liaison,@NotBlank String bedType,String threePiece,String threePieceNote,@NotNull Boolean costCut,Boolean promiseSigned,Boolean cleaningRequired,@PositiveOrZero BigDecimal moveInWater,@PositiveOrZero BigDecimal moveInElectric,@PositiveOrZero BigDecimal moveOutWater,@PositiveOrZero BigDecimal moveOutElectric,@NotNull LocalDate plannedMoveIn,LocalDate plannedMoveOut,String specialNote,String remark) {}
