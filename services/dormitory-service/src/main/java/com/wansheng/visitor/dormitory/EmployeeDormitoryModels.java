...
final class EmployeeDormitoryModels {
 ...
 record UpdateStayCommand(String name,String centerName,String department,@Pattern(regexp="男|女") String gender,String category,String positionName,String rankName,String applicationCode,String liaison,String bedType,String threePiece,String threePieceNote,Boolean costCut,Boolean promiseSigned,Boolean cleaningRequired,@PositiveOrZero BigDecimal moveInWater,@PositiveOrZero BigDecimal moveInElectric,@PositiveOrZero BigDecimal moveOutWater,@PositiveOrZero BigDecimal moveOutElectric,LocalDate plannedMoveIn,LocalDate plannedMoveOut,String specialNote,String remark) {}
 record StayImportCommand(String name,String centerName,String department,@Pattern(regexp="男|女") String gender,String category,String positionName,String rankName,String buildingName,String roomNo,String bedCode,String applicationCode,String liaison,String bedType,String threePiece,String threePieceNote,Boolean costCut,Boolean promiseSigned,Boolean cleaningRequired,@PositiveOrZero BigDecimal moveInWater,@PositiveOrZero BigDecimal moveInElectric,@PositiveOrZero BigDecimal moveOutWater,@PositiveOrZero BigDecimal moveOutElectric,LocalDate plannedMoveIn,LocalDate plannedMoveOut,String specialNote,String remark,String importedStatus) {}
