...
class GuardController {
 ...
 @PostMapping @ResponseStatus(HttpStatus.CREATED) GuardRecord create(@Valid @RequestBody GuardRecordRequest request,@RequestHeader("X-Operator") String op){return service.create(request,op);}
 @PutMapping("/{visitId}") GuardRecord update(@PathVariable String visitId,@Valid @RequestBody GuardRecordRequest request,@RequestHeader("X-Operator") String op){return service.update(visitId,request,op);}
